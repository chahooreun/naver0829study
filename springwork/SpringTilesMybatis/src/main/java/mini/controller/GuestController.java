...
public class GuestController {
	...
	private String bucketName="guest-cha";
	private String folderName="guest";

	//번역후 반환하는 메서드
	public String translate(String text1,String nara)
	{
		String clientId = "fas5q6a42u";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "GemAHtXVYqKzMk9zibbw7wGhF8El8kt4AlScW1OC";//애플리케이션 클라이언트 시크릿값";
        String returnValue="";
		try {
