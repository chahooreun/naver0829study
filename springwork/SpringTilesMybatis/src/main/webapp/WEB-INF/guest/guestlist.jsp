...
<div>
	...
	<c:forEach var="dto" items="${glist}">
		<div class="guest_box">
			...
			<img src="https://jqgroq4r1720.edge.naverncp.com/sDydHetxqS/guest/${dto.guest_photo}?type=f&w=100&h=100&faceopt=true&ttype=jpg"
...
<script type="text/javascript">
	$("img.smallphoto").click(function(){
		...
		//모달다이얼로그에 사진 넣기
		$("img.largephoto").attr("src",`https://kr.object.ncloudstorage.com/guest-cha/guest/\${photoname}`);
	});
</script>
</body>
</html>