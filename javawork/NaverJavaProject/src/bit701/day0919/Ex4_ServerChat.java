...
public class Ex4_ServerChat extends JFrame implements Runnable, ActionListener {
   String nickName;
   JTextArea area;
   ...
   private void setDesign() {
      ...
      tfNickName = new JTextField("차후련", 5);//자기이름으로 초기값
      ...
      btnConnect.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            Ex4_ServerChat.this.setTitle(nickName+"님 채팅창");

            //run 메소드 호출
            //Ex4_ClientChat 클래스의 인스턴스를 사용하여 스레드 생성, run메서드를 실행하기위해 사용
            Thread th = new Thread(Ex4_ServerChat.this);
            th.start();
         }
      });
   ...
   public static void main(String[] args) {
      // TODO Auto-generated method stub
      Ex4_ServerChat client = new Ex4_ServerChat();
   }
